...
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM.db", "P=lsredis:, EM=EM1, PORT=quadEM1")
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM.db", "P=lsredis:, EM=EM2, PORT=quadEM2")
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM.db", "P=lsredis:, EM=EM3, PORT=quadEM3")
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM.db", "P=lsredis:, EM=EM4, PORT=quadEM4")

# Database for FastSweep (mca records), i.e. quadEM digital scope
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM_med.db", "P=lsredis:quadEM:,NCHAN=2048,PORT=quadEMSweep")
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM_med_FFT.db", "P=lsredis:quadEM_FFT:,NCHAN=1024")
