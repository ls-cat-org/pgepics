...
dbLoadRecords("$(CAMAC)/camacApp/Db/CamacScaler.db","P=lsredis:,S=scaler1,C=0")
#dbLoadRecords("$(STD)/stdApp/Db/scaler.db","P=lsredis:,S=scaler1,C=0,DTYP=CAMAC scaler,FREQ=10000000")

# Load the DXP stuff
< 16element_dxp.cmd

# Generic CAMAC record
dbLoadRecords("$(CAMAC)/camacApp/Db/generic_camac.db","P=lsredis:,R=camac1,SIZE=2048")
