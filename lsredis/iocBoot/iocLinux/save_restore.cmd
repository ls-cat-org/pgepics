...
save_restoreSet_status_prefix("lsredis:")
dbLoadRecords("$(AUTOSAVE)/asApp/Db/save_restoreStatus.db", "P=lsredis:, DEAD_SECONDS=5")
...
set_pass0_restoreFile("auto_positions.sav", "P=lsredis:")
# Save positions every five seconds
doAfterIocInit("create_monitor_set('auto_positions.req',5,'P=lsredis:')")

set_pass0_restoreFile("auto_settings.sav", "P=lsredis:")
set_pass1_restoreFile("auto_settings.sav", "P=lsredis:")
# save settings every thirty seconds
doAfterIocInit("create_monitor_set('auto_settings.req',30,'P=lsredis:')")
...
#set_pass0_restoreFile("myGenericData.sav", "P=lsredis:")
#set_pass1_restoreFile("myGenericData.sav", "P=lsredis:")
...
set_requestfile_path("$(TOP)", "lsredisApp/Db")
