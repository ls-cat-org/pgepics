...
dbLoadRecords("$(TOP)/db/redis.db","P=21:mango,S=stns.4,RRH=localhost,RRP=6379,RRDB=0,RWH=mango-2.ls-cat.org,RWP=6379,RWDB=0,pgHost=10.1.0.3,pgPort=5432,pgUser=lsuser,pgDb=ls")
